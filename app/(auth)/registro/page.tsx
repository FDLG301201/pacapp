  ...
  async function onSubmit(data: RegisterInput) {
    ...
    if (error) {
      ...
      if (error.message.includes('already registered')) {
        setServerError('Ya existe una cuenta con ese correo. ¿Quieres iniciar sesión?')
      } else {
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-muted-foreground">
            Únete a la comunidad de moda sostenible más grande de RD
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                <Label>¿Cómo quieres usar PACAPP?</Label>
                <div className="grid grid-cols-2 gap-3">
                  ...
                  >
                    ...
                    <span className="font-medium">Soy comprador</span>
                    <span className="text-xs text-muted-foreground text-center">
                      Quiero buscar y comprar ropa
                    </span>
                  </button>
                  <button
                    type="button"
                  ...
                  >
                    ...
                    <span className="font-medium">Soy vendedor</span>
                    <span className="text-xs text-muted-foreground text-center">
                      Tengo una tienda de pacas
                    </span>
                  </button>
                </div>
                {errors.role && (
              ...
              <Button type="submit" className="w-full" size="lg" disabled={isSubmitting}>
                ...
                {selectedRole === 'seller' ? 'Registrar mi cuenta' : 'Crear mi cuenta'}
              </Button>
