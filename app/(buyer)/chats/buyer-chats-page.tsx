...
export default function BuyerChatsPage() {
  ...
  useEffect(() => {
    ...
    // Realtime: watch for conversation updates (new messages bump last_message)
  ...
  useEffect(() => {
    ...
    // Realtime: watch for new messages in this conversation
    const channel = supabase
      ...
      .on(
        ...
        async (payload) => {
          ...
          // If the incoming message is from the other party, clear unread
  ...
  const handleSelectConversation = (id: string) => {
    ...
    // Update local unread to 0 instantly (DB update happens in loadMessages)
    setConversations((prev) =>
